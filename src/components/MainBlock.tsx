...
const MainBlock: React.FC<MainBlockProps> = ({ title, desc, iconClass, gradientColors, hoverTextColor, onClick }) => {
  return (
    ...
    >
      ...
      <div className="relative h-full bg-zinc-900 border border-zinc-800 p-12 rounded-2xl text-center z-10 transition-all duration-500 group-hover:border-transparent">
        {/* ICON CONTAINER WITH NEW ANIMATION:
        ...
        */}
        <div className={`text-5xl mb-6 transition-transform duration-700 ease-in-out group-hover:rotate-[360deg] group-hover:scale-110 ${hoverTextColor}`}>
